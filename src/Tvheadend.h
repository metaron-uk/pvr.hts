 ...
 */
#define HTSP_MIN_SERVER_VERSION       (20) // Server must support at least this htsp version (20 == tvheadend 4.0.0)
#define HTSP_CLIENT_VERSION           (20) // Client uses HTSP features up to this version. If the respective
